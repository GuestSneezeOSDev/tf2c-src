...
CON_COMMAND_F(cl_ent_headshotfraction, "Displays the client's head fraction level, for the experimental headshot changes, for the entity under the crosshair", FCVAR_CHEAT)
{
	ToggleBBoxVisualization(CBaseEntity::VISUALIZE_HEADSHOT_LEVEL, args);
}

CON_COMMAND_F(cl_ent_projectilecylinder, "Displays the client's projectile hit detection cylinder, for the entity under the crosshair", FCVAR_CHEAT)
{
	ToggleBBoxVisualization(CBaseEntity::VISUALIZE_NEW_PROJECTILE_COLLIDERS, args);
}
