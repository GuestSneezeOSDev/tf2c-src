...
#ifdef TF_CLASSIC_CLIENT
	// Have to put it here because g_flexweight is private.
	static int iBlinkLeft = AddGlobalFlexController( "left_CloseLid" );
	static int iBlinkRight = AddGlobalFlexController( "right_CloseLid" );
