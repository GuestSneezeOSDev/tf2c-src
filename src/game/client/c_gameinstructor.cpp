...
//=========================================================
// if you do this in init, you create a race condition with asserts
// since the game might not know if you're in a debug session or not
// so it will call a __debugbreak and hard crash
void C_GameInstructor::PostInit()
{
