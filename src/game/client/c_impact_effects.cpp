...
static ConVar fx_drawimpactdebris( "fx_drawimpactdebris", "1", FCVAR_NONE, "Draw impact debris effects." );
static ConVar fx_drawimpactdust( "fx_drawimpactdust", "1", FCVAR_NONE, "Draw impact dust effects." );
