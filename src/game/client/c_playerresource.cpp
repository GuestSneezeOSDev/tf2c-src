...
//	memset( m_iPacketloss, 0, sizeof( m_iPacketloss ) );
	...
	int iSeed = random->RandomInt(0, INT_MAX);
	for( int i = 0; i <= MAX_PLAYERS; i++ )
	{
		m_szAnonName[i] = GetSeededRandomBotName( iSeed + i );
	}
#endif
...
#ifdef TF_CLASSIC_CLIENT
extern const char *g_aPlayerClassNames[TF_CLASS_COUNT_ALL];
#endif
