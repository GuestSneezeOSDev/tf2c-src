...
// 20170721: Fixed security vulnerability
...
// Automatic tokenLen determination for cases where token is an array buffer
...
// returns a pointer to an array of size argNumOfWorldLights dworldlight_t objects that contain the current map's worldlights
// nullptr if failure
// argNumOfWorldLights gets populated by the function
