...
#if defined( TF_CLIENT_DLL ) || defined( DOD_DLL ) || defined( TF_CLASSIC_CLIENT )
...
//-----------------------------------------------------------------------------
// All code below this point is from the VDC, for backporting the Game Instructor to SDK2013
//-----------------------------------------------------------------------------
CHudIcons::CHudIcons() :
	m_bHudTexturesLoaded( false )
{
