...
public:
	...
	virtual const char *GetHudStatusIcon( void ) const;
	...
	friend class C_ObjectFlameSentry;
...
class C_ObjectFlameSentry : public C_ObjectSentrygun
{
	DECLARE_CLASS(C_ObjectFlameSentry, C_ObjectSentrygun);
public:
	C_ObjectFlameSentry();
	~C_ObjectFlameSentry();
	bool m_bHasFlames;
