...
void CTFOptionsMousePanel::CreateControls()
{
	...
	pTitleMouse = new Label( this, "DescTextTitle", "#GameUI_TitleMouse" );
	...
	m_pMouseRawCheckBox = new CTFCvarToggleCheckButton( this, "RawInput", "#GameUI_MouseRaw", "m_rawinput" );
	m_pMouseSensitivitySlider = new CTFCvarSlider( this, "MouseSensitivity", 0.1f, 20.0f, "sensitivity", true );
	...
	///
	pTitleJoystick = new Label( this, "DescTextTitle", "#GameUI_TitleJoystick" );
	...
	AddControl( m_pMouseRawCheckBox, O_BOOL, "", "#GameUI_MouseRaw_Hint" );
