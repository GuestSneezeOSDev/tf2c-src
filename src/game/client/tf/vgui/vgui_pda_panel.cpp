...
// #include <vgui_controls/CircularProgressBar.h> // TODO: use inheritance so we can include both
...
private:
	...
	CircularProgressBarSegmented *m_pInvisProgress;
};
	...
	: CPDAPanel( parent, "CPDAPanel_Spy_Invis_Pocket" ) 
{
	...
	CircularProgressBarSegmented *m_pCircularInvisProgress = new CircularProgressBarSegmented( this, "InvisProgress" );
	m_pCircularInvisProgress->SetProgressDirection( 1 ); // counterclockwise
	m_pInvisProgress = m_pCircularInvisProgress;
}
