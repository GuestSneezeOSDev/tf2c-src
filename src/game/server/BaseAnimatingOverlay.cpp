...
BEGIN_ENT_SCRIPTDESC( CBaseAnimatingOverlay, CBaseAnimating, "Entities which have layered animations" )
	DEFINE_SCRIPTFUNC_NAMED( ScriptAddGesture, "AddGesture", "Add a layered gesture activity. You MUST call RegisterActivityConstants before using this and activity names." )
	DEFINE_SCRIPTFUNC_NAMED( ScriptAddGestureSequence, "AddGestureSequence", "Add a layered gesture sequence." )
	DEFINE_SCRIPTFUNC_NAMED( ScriptIsPlayingGesture, "IsPlayingGesture", "Returns if the specified activity is playing. You MUST call RegisterActivityConstants before using this and activity names." )
	DEFINE_SCRIPTFUNC_NAMED( ScriptRestartGesture, "RestartGesture", "Restart a currently playing activity, optionally playing it if it's not already. You MUST call RegisterActivityConstants before using this and activity names." )
	DEFINE_SCRIPTFUNC_NAMED( ScriptRemoveGesture, "RemoveGesture", "Stop the specified activity. You MUST call RegisterActivityConstants before using this and activity names." )
END_SCRIPTDESC()
...
int CBaseAnimatingOverlay::ScriptAddGestureSequence( int sequence, float flDuration, bool autokill )
{
	return AddGestureSequence( sequence, flDuration, autokill );
}

int CBaseAnimatingOverlay::ScriptAddGesture( int activity, float flDuration, bool autokill )
{
	return AddGesture( (Activity)activity, flDuration, autokill );
}

bool CBaseAnimatingOverlay::ScriptIsPlayingGesture( int activity )
{
	return IsPlayingGesture( (Activity)activity );
}

void CBaseAnimatingOverlay::ScriptRestartGesture( int activity, bool addifmissing, bool autokill )
{
	RestartGesture( (Activity)activity, addifmissing, autokill );
}

void CBaseAnimatingOverlay::ScriptRemoveGesture( int activity )
{
	RemoveGesture( (Activity)activity );
}
