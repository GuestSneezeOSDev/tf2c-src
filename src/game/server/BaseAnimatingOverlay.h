...
public:
	...
	DECLARE_ENT_SCRIPTDESC( CBaseAnimatingOverlay );
private:
...
public:
	...
	int		ScriptAddGestureSequence( int sequence, float flDuration, bool autokill );
	int		ScriptAddGesture( int activity, float flDuration, bool autokill );
	bool	ScriptIsPlayingGesture( int activity );
	void	ScriptRestartGesture( int activity, bool addifmissing, bool autokill );
	void	ScriptRemoveGesture( int activity );
