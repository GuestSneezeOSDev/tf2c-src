...
//===========================
    ...
    // Hunting Revolver
    ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ALT);
    ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ALT);
    ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_SWIM_PRIMARY_DEPLOYED_ALT);
    ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_PRIMARY_DEPLOYED_ALT);
    ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_PRIMARY_DEPLOYED_ALT);
    ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_PRIMARY_DEPLOYED_ALT);
