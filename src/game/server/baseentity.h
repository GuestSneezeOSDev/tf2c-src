...
CBaseEntity *ScriptCreateEntityFromTable( const char *className, HSCRIPT hTable );
...
public:
	...
	DECLARE_DATADESC();
	// scripting
	DECLARE_ENT_SCRIPTDESC( CBaseEntity );
...
#ifdef TF_CLASSIC
	virtual	bool			ShouldCollide( int collisionGroup, int contentsMask, const IHandleEntity *pEnt ) const;
#endif
...
//	const QAngle&	GetAbsAngularVelocity( ) const;
	...
	virtual bool IsDeflectableSwapTeam() { return true; }
...
public:
	...
	CBaseHandle ScriptGetEHandle() { return GetRefEHandle(); }
...
public:
	...
	int ScriptTakeDamage( float flDamage, int nDamageType, HSCRIPT hAttacker );
...
public:
	...
	void ScriptSetLocalAngles( const QAngle &angles );
	...
	void ScriptEnableDraw();
	void ScriptDisableDraw();
...
inline void CBaseEntity::ScriptSetLocalAngles( QAngle const &angles )
{
...
inline void CBaseEntity::ScriptEnableDraw()
{
	RemoveEffects( EF_NODRAW );
}

inline void CBaseEntity::ScriptDisableDraw()
{
