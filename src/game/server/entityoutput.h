...
public:
	...
	void ScriptRemoveEventAction( CEventAction *pEventAction, const char *pszTargetName, const char *pszInputName, const char *pszParameter );
	...
	SERVERONLY_EXPORT void FireOutput( variant_t Value, CBaseEntity *pActivator, CBaseEntity *pCaller, float fDelay = 0 );
