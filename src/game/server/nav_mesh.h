...
public:
	...
	virtual NavErrorType LoadCustomData( CUtlBuffer &fileBuffer, unsigned int subVersion ) { return NAV_OK; }			// load custom mesh data for derived classes
	...
	virtual NavErrorType LoadCustomDataPreArea( CUtlBuffer &fileBuffer, unsigned int subVersion ) { return NAV_OK; }	// load custom mesh data for derived classes that needs to be loaded before areas are read in
#else
	virtual void SaveCustomData( CUtlBuffer &fileBuffer ) const { }								// store custom mesh data for derived classes
