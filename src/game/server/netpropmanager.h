...
private:
	...
	inline void CollectNestedDataMaps( datamap_t *pMap, CBaseEntity *pBaseEntity, int nDepth, HSCRIPT hTable );
	inline void StoreDataMapValue( typedescription_t *td, CBaseEntity *pBaseEntity, int nOffset, int element, HSCRIPT hTable );

	inline void CollectNestedSendProps( SendTable *pSendTable, CBaseEntity *pBaseEntity, int nDepth, HSCRIPT hTable );
	inline void StoreSendPropValue( SendProp *pProp, CBaseEntity *pBaseEntity, int nOffset, int element, HSCRIPT hTable );
...
#define SetPropFunc(name, varType) \
	...
	GetPropFunc( Bool, bool );
	SetPropFunc( Bool, bool );
...
#undef SetPropFunc
	...
	bool GetPropInfo( HSCRIPT hEnt, const char *pszProperty, int element, HSCRIPT hTable );

	void GetTable( HSCRIPT hEnt, int nTableType, HSCRIPT hTable );
};
