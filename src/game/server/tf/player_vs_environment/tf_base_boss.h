...
public:
	...
	virtual CTFBaseBossLocomotion *GetLocomotionInterface( void ) const OVERRIDE { return m_locomotor; }

	virtual float GetDesiredPathLookAheadRange() const { return -1.0f; }
