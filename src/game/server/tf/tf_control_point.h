...
#ifndef TF_CONTROL_POINT_H
#define TF_CONTROL_POINT_H
#ifdef _WIN32
#pragma once
#endif
...
public:
	...
	int			GetDominationRate( void ) { return m_iDominationRate; };
...
private:
	...
	int			m_iDominationRate;				// TF2C Domination points per 1 second
	...
	perteamdata_t	m_TeamData[TF_TEAM_COUNT];
