...
public:
	...
	void Event_PlayerHealedOther( CTFPlayer *pPlayer, float iAmount );
	void Event_PlayerBlockedDamage( CTFPlayer *pPlayer, int iAmount );
	...
	void Event_PlayerUsedJumppad( CTFPlayer *pJumppadOwner, CTFPlayer *pJumpingPlayer );
	...
	void Event_PlayerScoresEscortPoints( CTFPlayer *pPlayer, int iAmount );
	void Event_PlayerMovedToSpectators( CTFPlayer *pPlayer );
	...
	void						ResetKillHistory( CTFPlayer *pPlayer, bool bTeammatesOnly = false );
