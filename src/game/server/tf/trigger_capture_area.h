...
#ifndef TRIGGER_CAPTURE_AREA_H
#define TRIGGER_CAPTURE_AREA_H
#ifdef _WIN32
#pragma once
#endif
...
private:
	void	AreaTouch( CBaseEntity *pOther );
...
private:
	...
	bool m_bVIPOnly;	// used for the VIP mode

	DECLARE_DATADESC();
};

#endif // TRIGGER_CAPTURE_AREA_H
