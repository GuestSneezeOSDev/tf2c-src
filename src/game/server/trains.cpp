...
const Vector &CFuncTrackTrain::ScriptGetFuturePosition( float flSpeed, float flDeltaT )
{
	static Vector position;

	position = GetLocalOrigin();
	position.z -= m_height;
	m_ppath->LookAhead( position, flSpeed * flDeltaT, TRUE );
