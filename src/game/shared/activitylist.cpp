...
//HL2MP
	...
	// Hunting Revolver
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_PRIMARY_DEPLOYED_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_PRIMARY_DEPLOYED_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_PRIMARY_DEPLOYED_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_PRIMARY_DEPLOYED_ALT );
