...
enum
{
	ACHIEVEMENT_TYPE_TRIVIAL,
	ACHIEVEMENT_TYPE_MINOR,
	ACHIEVEMENT_TYPE_MAJOR,
	ACHIEVEMENT_TYPE_PLAYER,
	ACHIEVEMENT_TYPE_ROUND,
	ACHIEVEMENT_TYPE_MISTAKE,
...
public:
	...
	void SetType( int iType ) { m_iAchievementType = iType; }
	int GetType() { return m_iAchievementType; }
	...
	const char **GetComponentNames() { return m_pszComponentNames; }
...
protected:
	...
	float m_flProgressMsgIncrement;
