...
{
public:
	DECLARE_CLASS( CBaseCombatWeapon, CEconEntity );
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();
	DECLARE_ENT_SCRIPTDESC( CBaseCombatWeapon );
	...
	void					SetCustomViewModel( char const *pszViewModel );
	void					SetCustomViewModelModelIndex( int iViewModel );
	...
	virtual void			UpdateBurstFire( void );
...
public:
	...
	bool HasInfiniteAmmo() { return m_bInfiniteAmmo; };
...
public:
	...
	CNetworkVar( int, m_iRoundsLeftInBurst );
	// Weapon state
