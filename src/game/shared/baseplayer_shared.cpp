...
void CBasePlayer::ItemPostFrame()
{
	...
	if ( pActiveWeapon )
	{
		if ( gpGlobals->curtime < m_flNextAttack )
		{
			pActiveWeapon->ItemBusyFrame();
		}
		else if ( !IsInAVehicle() || UsingStandardWeaponsInVehicle() )
		{
#if defined( CLIENT_DLL )
			// Not predicting this weapon
...
// Output : const Vector
//-----------------------------------------------------------------------------
Vector CBasePlayer::GetPlayerMins( void ) const
{
	if ( IsObserver() )
	{
...
// Output : const Vector
//-----------------------------------------------------------------------------
Vector CBasePlayer::GetPlayerMaxs( void ) const
{	
	if ( IsObserver() )
	{
