...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_CL_MAG_EJECT, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_MAG_EJECT_UNHIDE, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_WPN_DRAW, AE_TYPE_SERVER | AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_WPN_RELOAD, AE_TYPE_SERVER | AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_MAG_EJECT_VM, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_MAG_EJECT_UNHIDE_VM, AE_TYPE_CLIENT );
#endif
}