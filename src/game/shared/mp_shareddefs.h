...
enum
{
	...
	// Team Fortress 2 Classic Concepts
#if defined( TF_CLASSIC ) || defined( TF_CLASSIC_CLIENT )
	MP_CONCEPT_PLAYER_SUCCESS,				// "TLK_PLAYER_SUCCESS"
	MP_CONCEPT_PLAYER_FAILURE,				// "TLK_PLAYER_FAILURE"
	MP_CONCEPT_PLAYER_DETONATOR_ACTIVATION,	// "TLK_PLAYER_DETONATOR_ACTIVATION"
	MP_CONCEPT_JUMPPAD_LAUNCHED,			// "TLK_JUMPPAD_LAUNCHED"
	MP_CONCEPT_PILLSTREAK_CHARGED,			// "TLK_PILLSTREAK_CHARGED"
	MP_CONCEPT_CIVILIAN_PROTECT,			// "TLK_CIVILIAN_PROTECT"
	MP_CONCEPT_WINDAAGUN,					// "TLK_WINDAAGUN"
	MP_CONCEPT_FIREAAGUN,					// "TLK_FIREAAGUN"
	MP_CONCEPT_AAGUN_FIREWEAPON,			// "TLK_AAGUN_FIREWEAPON"
#endif
