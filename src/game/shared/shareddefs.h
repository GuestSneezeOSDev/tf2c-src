...
#if defined(TF_DLL) || defined(TF_CLIENT_DLL) || defined(TF_CLASSIC) || defined(TF_CLASSIC_CLIENT)
	#define MAX_WEAPONS				6	// Max number of weapons available
#else
...
#if defined( CSTRIKE_DLL ) || defined ( TF_CLASSIC ) || defined ( TF_CLASSIC_CLIENT )
...
#ifdef TF_CLASSIC
	ITraceFilter* m_pCustomFilter = nullptr;
#endif
...
enum
{
	SCHEME_CLIENT_PATHSTRING,
	SCHEME_CLIENT_PATHSTRINGTF2C,
	SCHEME_CLIENT_STRING,
	SCHEME_CLIENT_STRINGTF2C,
	SCHEME_CHAT_PATHSTRING,
	SCHEME_CHAT_STRING,
	SCHEME_SOURCE_PATHSTRING,
	SCHEME_SOURCE_STRING,
	SCHEME_COUNT,
};

extern const char* ClientSchemesArray[SCHEME_COUNT];
#endif
