...
"\n"
"|| ============================================================ ||\n"
"|| Sorry, the server you tried to connect to has been marked by ||\n"
"|| developers as malicious. If you believe this to be in error, ||\n"
"|| please contact the developers at https://tf2classic.com.     ||\n"
"|| ============================================================ ||\n"
"\n";
...
#endif
{
    ...
    if (cvar->FindVar("tf2c_flush_downloads_on_dc")->GetBool())
    {
        engine->ClientCmd_Unrestricted("flush_dls\n");
    }
    else if (cvar->FindVar("tf2c_flush_sprays_on_dc")->GetBool())
    {
