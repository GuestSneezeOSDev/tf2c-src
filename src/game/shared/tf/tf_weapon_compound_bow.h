...
// Server specific.
	...
	virtual bool	CanPickupOtherWeapon() const { return m_flChargeBeginTime == 0.0f; }

	// ITFChargeUpWeapon
	virtual bool	ChargeMeterShouldFlash();
	...
	bool			GetArrowAlight( void ) { return m_bArrowAlight; }
