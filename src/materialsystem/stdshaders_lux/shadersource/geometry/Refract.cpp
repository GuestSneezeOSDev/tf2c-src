...
void LuxRefract_Link_Params(Geometry_Vars_t &info)
{

}

void LuxRefract_Init_Params(CBaseVSShader *pShader, IMaterialVar **params, const char *pMaterialName, Geometry_Vars_t &info)
{

}

void LuxRefract_Shader_Init(CBaseVSShader *pShader, IMaterialVar **params, Geometry_Vars_t &info)
{

}

void LuxRefract_Shader_Draw(CBaseVSShader *pShader, IMaterialVar **params, IShaderDynamicAPI *pShaderAPI, IShaderShadow *pShaderShadow, Geometry_Vars_t &info, VertexCompressionType_t vertexCompression, CBasePerMaterialContextData **pContextDataPtr)
{
...
BEGIN_VS_SHADER(LUX_Refract, "ShiroDkxtro2's ACROHS Shader-Rewrite Shader")
...
SHADER_INIT_PARAMS()
{
	...
	LuxRefract_Link_Params(vars);
	LuxRefract_Init_Params(this, params, pMaterialName, vars);
}
...
SHADER_INIT
{
	Geometry_Vars_t vars;
	LuxRefract_Link_Params(vars);
	LuxRefract_Shader_Init(this, params, vars);
}
...
SHADER_DRAW
{
	Geometry_Vars_t vars;
	LuxRefract_Link_Params(vars);
	LuxRefract_Shader_Draw(this, params, pShaderAPI, pShaderShadow, vars, vertexCompression, pContextDataPtr);
