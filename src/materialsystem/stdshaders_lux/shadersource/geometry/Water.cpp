...
//
//	Purpose of this File :	Water Shader, with some additions from ASW
//
//===========================================================================//
...
void LuxWater_Link_Params(Geometry_Vars_t &info)
{

}

void LuxWater_Init_Params(CBaseVSShader *pShader, IMaterialVar **params, const char *pMaterialName, Geometry_Vars_t &info)
{

}

void LuxWater_Shader_Init(CBaseVSShader *pShader, IMaterialVar **params, Geometry_Vars_t &info)
{

}

void LuxWater_Shader_Draw(CBaseVSShader *pShader, IMaterialVar **params, IShaderDynamicAPI *pShaderAPI, IShaderShadow *pShaderShadow, Geometry_Vars_t &info, VertexCompressionType_t vertexCompression, CBasePerMaterialContextData **pContextDataPtr)
{
...
DEFINE_FALLBACK_SHADER(SDK_Water_DX9_HDR0, LUX_Water)
...
BEGIN_VS_SHADER(LUX_Water, "ShiroDkxtro2's ACROHS Shader-Rewrite Shader")
...
SHADER_INIT_PARAMS()
{
	...
	LuxWater_Link_Params(vars);
	LuxWater_Init_Params(this, params, pMaterialName, vars);
}
...
SHADER_INIT
{
	Geometry_Vars_t vars;
	LuxWater_Link_Params(vars);
	LuxWater_Shader_Init(this, params, vars);
}
...
SHADER_DRAW
{
	Geometry_Vars_t vars;
	LuxWater_Link_Params(vars);
	LuxWater_Shader_Draw(this, params, pShaderAPI, pShaderShadow, vars, vertexCompression, pContextDataPtr);
