...
public:
	...
	CMaterialReference( const char* pMaterialName = 0, const char *pTextureGroupName = 0, bool bComplain = true );
	~CMaterialReference();
...
public:
	...
	// Attach to a texture
	void Init( const char* pTexture, const char *pTextureGroupName, bool bComplain = true );
