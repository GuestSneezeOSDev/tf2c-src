...
//	UNUSED											= (1 << 0),
	...
	MATERIAL_VAR2_DISTANCEALPHA								= (1 << 20), // This flag cannot be set through VMT and has to be set by the Shader.
	MATERIAL_VAR2_CLOAK										= (1 << 21), // This flag cannot be set through VMT and has to be set by the Shader.
	MATERIAL_VAR2_EMISSIVEBLEND								= (1 << 22), // This flag cannot be set through VMT and has to be set by the Shader.
	MATERIAL_VAR2_FLESHINTERIOR								= (1 << 23), // This flag cannot be set through VMT and has to be set by the Shader.
};
