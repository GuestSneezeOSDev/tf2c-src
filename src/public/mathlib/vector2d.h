...
#if (defined(TF_CLASSIC) || defined(TF_CLASSIC_CLIENT)) && !defined(VECTOR_PARANOIA)
#include "tier0/platform.h"
#ifndef BOOST_NO_CXX11_CONSTEXPR
#define VECTOR_CONSTEXPR_CTOR
#endif
#endif
...
public:
	...
	Vector2D(void);
#ifdef VECTOR_CONSTEXPR_CTOR
	constexpr Vector2D(vec_t X, vec_t Y) : x(X), y(Y) {}
#else
