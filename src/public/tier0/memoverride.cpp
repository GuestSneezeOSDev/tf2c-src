...
extern "C"
{
    ...
    // winsdk bullshit
    // probably could also do #ifdef _CRT_NOEXCEPT
    // but whatever
    // this avoids an error where _msize_base has different except specs than
    // the win sdk version of this func
    // -sappho
    // NTDDI_WIN10_CO
#if NTDDI_VERSION >= 0x0A00000B /* NTDDI_WIN10_CO */
